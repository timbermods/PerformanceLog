...
namespace PerformanceLog
{
    ...
    public static class ProfileKinds
    {
        ...
        public static readonly string[] Meaning =
        {
            ...
            "One method from the Watch list in the config, timed including everything inside it and every patch on it. Calls are counted exactly; the first call in each window and about every Nth after it are timed, N widening only while that method itself is busy. It has a row for every window it ran in.",
