...
namespace PerformanceLog.Tests
{
    ...
    internal static class SampleSession
    {
        ...
        public static void Write(string directory, bool withMod = true, int seed = 7)
        {
            ...
            header.Mod("kyler.performancelog", "Performance Log", "v0.1.2");
            ...
            File.WriteAllText(Path.Combine(directory, "README.md"), SessionReadme.Render(ReadTemplate(), "0.1.2"));
            File.WriteAllText(Path.Combine(directory, "columns.md"), SessionReadme.RenderColumns("0.1.2"));
        ...
        static SummaryInput BuildInput(bool withMod, string status)
        {
            ...
            {
                SessionId = "sample-" + (withMod ? "with-mod" : "without-mod"), Status = status, ModVersion = "0.1.2", GameVersion = "1.1.2.4 (sample)",
            ...
            input.Mods.Add(new[] { "kyler.performancelog", "Performance Log", "v0.1.2" });
